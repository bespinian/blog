...
Prometheus uses a simple text based format as shown below. The [Prometheus docs](https://prometheus.io/docs/instrumenting/exposition_formats/#text-format-example) provide more information.
...
- Counters provide valuable insight when used in combination with the `rate()` or `increase()` functions.
