...
**✅ Add distributed tracing to all your functions.**
...
## Level 4: Speeding Up - Optimizing Cold Starts

**Mistake: Ignoring Cold Start Performance**

Cold starts, the initial latency experienced when a Lambda function is invoked
after a period of inactivity, can impact performance. **Why is this important?**
In latency-sensitive applications, even a few extra milliseconds can be
noticeable to users. This level explores techniques to minimize cold start
times, such as moving initialization code outside the handler. By optimizing our
function's startup process, we can enhance responsiveness and improve the
overall user experience. **Optimize for cold starts early to avoid performance
bottlenecks later.**
